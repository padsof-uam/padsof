...
public class Assert
{
	public static <T extends Comparable<T>> void assertListEquals(
	...
	public static <T> void assertIsSubset(Iterable<T> subset,
			Iterable<T> superset)
	{
		for (T item : subset)
	...
	public static <T> void assertAreSameCollection(Iterable<T> expected,
			Iterable<T> actual)
	{
	...
	public static <T> void assertFieldWiseEquals(T expected, T actual,
			String... excludedFields) throws IllegalArgumentException,
			IllegalAccessException
	{
		assertFieldWiseEquals("", expected, actual, excludedFields);
	}

	public static <T> void assertFieldWiseEquals(String message, T expected,
			T actual, String... excludedFields)
			throws IllegalArgumentException, IllegalAccessException
	{
		...
		for (Field field : Reflection.getAllFieldsFrom(expected.getClass()))
		{
			...
			if (!excluded.contains(field.getName()))
				assertEquals(message + " - failed field " + field.getName(),
						field.get(expected), field.get(actual));
		}
	}
}
