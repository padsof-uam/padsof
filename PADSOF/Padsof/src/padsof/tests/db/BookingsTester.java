...
public class BookingsTester
{
	...
	@Test
	public void testCreateSaveFlightBooking() throws SQLException, IllegalArgumentException, IllegalAccessException
	{
		Flight f = new Flight();
	...
	@Test
	public void testCreateSaveHotelBooking() throws IllegalArgumentException, IllegalAccessException, SQLException
	{
		Hotel h = new Hotel(
				"España",
				"Madrid",
	...
	@Test
	public void testCreateSaveImsersoTravel() throws IllegalArgumentException, IllegalAccessException, SQLException
	{
		...
		ImsersoTravelBooking itb = (ImsersoTravelBooking) bf.book(it, c, start, end);
		
		db.save(itb);
		
		ImsersoTravelBooking retrieved = db.getAll(ImsersoTravelBooking.class).get(0);
	...
	@Test
	public void testCreateSaveTravel() throws IllegalArgumentException, IllegalAccessException, SQLException
	{
		Travel t = new Travel(
				"Mallorca-1",
				"Halc�n Viajes",
...
/*
java.sql.SQLException: Unable to run insert stmt on object padsof.bookings.FlightBooking@58278ad3: INSERT INTO `flightbooking` (`bookingLocalizer` ,`associatedFlight_id` ,`client_id` ,`state` ,`start` ,`end` ,`vendorUser_id` ) VALUES (?,?,?,?,?,?,?)
...
at padsof.tests.db.BookingsTester.testCreateSaveFlightBooking(BookingsTester.java:96)
...
Caused by: java.sql.SQLException: Unable to run insert stmt on object padsof.system.Client@1467056e: INSERT INTO `client` (`name` ,`surname` ,`DNI` ) VALUES (?,?,?)
at com.j256.ormlite.misc.SqlExceptionUtil.create(SqlExceptionUtil.java:22)
at com.j256.ormlite.stmt.mapped.MappedCreate.insert(MappedCreate.java:124)
at com.j256.ormlite.stmt.StatementExecutor.create(StatementExecutor.java:394)
at com.j256.ormlite.dao.BaseDaoImpl.create(BaseDaoImpl.java:308)
...
... 30 more
Caused by: java.sql.SQLException: [SQLITE_ERROR] SQL error or missing database (no such table: client)
...
at com.j256.ormlite.jdbc.JdbcDatabaseConnection.insert(JdbcDatabaseConnection.java:171)
