...
public class SystemObjectsTest
{
	...
	@Test
	public void testSaveClient() throws IllegalArgumentException,
	...
	@Test
	public void testSaveImsersoClient() throws IllegalArgumentException,
			IllegalAccessException, SQLException
	{
	...
	public void testPacket() throws Exception
	{
		...
		ImsersoTravelBooking itb = (ImsersoTravelBooking) bf.book(it, client,
				start, end);
