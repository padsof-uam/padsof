	...
	public void DBFeederTravel (String file) throws Exception{
		...
		try{
			for (List<String> iterator:data){
				travels.add(new Travel(iterator.get(0),
					iterator.get(1),iterator.get(2),
					Double.parseDouble(iterator.get(3)),
					Integer.parseInt(iterator.get(4)),
					Integer.parseInt(iterator.get(5)),
					iterator.get(6), iterator.get(8),
					iterator.get(8),iterator.get(9)));
			}
	...
	public void DBFeederHotel(String file) throws Exception{
		...
		for(List<String> iterator : data){
			hotels.add(new Hotel(
					iterator.get(0),iterator.get(1),iterator.get(2),iterator.get(3),
					iterator.get(4),iterator.get(5),iterator.get(6),
					Double.parseDouble(iterator.get(7)),
					...
					Double.parseDouble(iterator.get(12)),
					iterator.get(13)));			
		}
		} catch (Exception e){
